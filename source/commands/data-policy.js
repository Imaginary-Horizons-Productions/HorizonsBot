...
const options = [];
const subcommands = [];
module.exports = new Command(customId, "Get a link to the HorizonsBot's Data Policy page", PermissionFlagsBits.ViewChannel, false, true, 3000, options, subcommands,

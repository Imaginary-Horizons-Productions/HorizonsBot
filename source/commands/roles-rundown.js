...
const customId = "roles-rundown";
const options = [];
const subcommands = [];
module.exports = new Command(customId, "See what the roles on the server mean and how to get them", false, null, 3000, options, subcommands);

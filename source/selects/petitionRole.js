		...
		if (interaction.values.length > 1) {
			...
			switch (stats.result) {
				...
				case "duplicateSignature":
					interaction.reply({ content: `You've already petitioned for a ${interaction.values[0]} Pingable Role.`, ephemeral: true });
					break;
				case "petitionFulfilled":
					interaction.reply({ content: `The ${interaction.values[0]} Pingable Role has been created and given to petitioners.`, ephemeral: true });
					break;
			}
		}
